...
public class Homepage {
    ...
    public void homepage() throws InterruptedException {
        ...
        Assert.assertEquals(driver.getTitle(), "Accessories");
    ...
    public void languages() throws InterruptedException {
        ...
        Select select4 = new Select(driver.findElement(By.cssSelector("#select-language")));

        Assert.assertEquals(1, select4.getAllSelectedOptions().size());
